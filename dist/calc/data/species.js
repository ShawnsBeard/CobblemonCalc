...
var SV_PATCH = {
    ...
    'Ambipom-Delta': {
        types: ['Normal', 'Ghost'],
        bs: { hp: 65, at: 115, df: 68, sa: 56, sd: 75, sp: 103 },
        weightkg: 18.6,
        abilities: { 0: 'Technician' }
    },
    'Ambipom-Ultra': {
    ...
    'Ancient Gene': {
        types: ['Psychic', 'Normal'],
        bs: { hp: 105, at: 95, df: 95, sa: 95, sd: 95, sp: 105 },
        weightkg: 4,
        gender: 'N',
    ...
    'Chimecho-Delta': {
        types: ['Dark', 'Psychic'],
        bs: { hp: 75, at: 50, df: 70, sa: 105, sd: 80, sp: 75 },
        weightkg: 1,
        abilities: { 0: 'Levitate' }
    },
    Chuggalong: {
    ...
    'Cloyster-Delta': {
        types: ['Ice', 'Poison'],
        bs: { hp: 50, at: 115, df: 165, sa: 65, sd: 55, sp: 75 },
        weightkg: 122,
        abilities: { 0: 'Shell Armor' }
    },
    'Corsola-Delta': {
        types: ['Grass'],
        bs: { hp: 90, at: 45, df: 65, sa: 85, sd: 85, sp: 40 },
        weightkg: 4,
        abilities: { 0: 'Natural Cure' },
        nfe: true
    },
    ...
    Draceon: {
        types: ['Dragon'],
        bs: { hp: 110, at: 130, df: 65, sa: 65, sd: 60, sp: 95 },
        weightkg: 30,
        abilities: { 0: 'Mold Breaker' }
    },
    'Dragapult-Ultra': {
    ...
    Dragascue: {
        types: ['Dragon', 'Ice'],
        bs: { hp: 80, at: 112, df: 100, sa: 88, sd: 60, sp: 120 },
        weightkg: 60,
        abilities: { 0: 'Clear Body' }
    },
    Dragetsu: {
    ...
    Drifblimp: {
        types: ['Ghost', 'Flying'],
        bs: { hp: 200, at: 58, df: 62, sa: 100, sd: 70, sp: 60 },
        weightkg: 120,
        abilities: { 0: 'Stamina' }
    },
    'Druddigon-Delta': {
    ...
    Dunsparath: {
        types: ['Dragon', 'Electric'],
        bs: { hp: 115, at: 60, df: 60, sa: 125, sd: 80, sp: 80 },
        weightkg: 53.5,
        abilities: { 0: 'Levitate' }
    },
    'Dunsparce-Ultra': {
        types: ['Dragon', 'Electric'],
        bs: { hp: 100, at: 40, df: 55, sa: 85, sd: 70, sp: 65 },
        weightkg: 13,
        abilities: { 0: 'Neutralizing Gas' }
    },
    Ectarachnid: {
        types: ['Bug', 'Ghost'],
        bs: { hp: 90, at: 120, df: 100, sa: 70, sd: 80, sp: 65 },
        weightkg: 40.5,
        abilities: { 0: 'Swarm' }
    },
    Eeveeon: {
        types: ['Normal'],
        bs: { hp: 75, at: 100, df: 75, sa: 100, sd: 75, sp: 100 },
        weightkg: 25,
        abilities: { 0: 'Adaptability' }
    },
    Electisaur: {
        types: ['Grass', 'Electric'],
        bs: { hp: 92, at: 108, df: 88, sa: 112, sd: 80, sp: 80 },
        weightkg: 116,
        gender: 'N',
        abilities: { 0: 'Motor Drive' }
    },
    ...
    Eruptois: {
        types: ['Fire', 'Water'],
        bs: { hp: 80, at: 65, df: 170, sa: 105, sd: 75, sp: 20 },
        weightkg: 180,
        abilities: { 0: 'White Smoke' }
    },
    Espathra: {
    ...
    'Falinks-Delta': {
        types: ['Fighting', 'Steel'],
        bs: { hp: 65, at: 110, df: 110, sa: 45, sd: 70, sp: 70 },
        weightkg: 100,
        gender: 'N',
        abilities: { 0: 'Filter' }
    },
    ...
    'Furret-Delta': {
        types: ['Normal', 'Ice'],
        bs: { hp: 90, at: 52, df: 95, sa: 38, sd: 65, sp: 75 },
        weightkg: 30,
        abilities: { 0: 'Soundproof' }
    },
    'Garchomp-Delta': {
    ...
    Gholdaton: {
        types: ['Fairy', 'Steel'],
        bs: { hp: 92, at: 92, df: 80, sa: 80, sd: 120, sp: 96 },
        weightkg: 280,
        gender: 'N',
        abilities: { 0: 'Mold Breaker' }
    },
    ...
    Glimmerix: {
        types: ['Ghost', 'Steel'],
        bs: { hp: 53, at: 103, df: 151, sa: 101, sd: 83, sp: 79 },
        weightkg: 132.0,
        gender: 'N',
        abilities: { 0: 'Beast Boost' }
    },
    ...
    'Gogoat-Delta': {
        types: ['Normal', 'Steel'],
        bs: { hp: 100, at: 133, df: 90, sa: 59, sd: 61, sp: 88 },
        weightkg: 123.5,
        abilities: { 0: 'Guts' }
    },
    'Golurk-Delta': {
    ...
    'Gorebyss-Delta': {
        types: ['Dragon', 'Fairy'],
        bs: { hp: 55, at: 93, df: 95, sa: 112, sd: 70, sp: 60 },
        weightkg: 26.6,
        abilities: { 0: 'Hydration' }
    },
    Gorochu: {
        types: ['Electric'],
        bs: { hp: 60, at: 120, df: 90, sa: 90, sd: 130, sp: 110 },
        weightkg: 59,
        abilities: { 0: 'Transistor' }
    },
    'Gouging Fire': {
    ...
    'Greninja-Delta': {
        types: ['Water', 'Rock'],
        bs: { hp: 72, at: 125, df: 75, sa: 83, sd: 66, sp: 109 },
        weightkg: 45,
        abilities: { 0: 'Torrent' }
    },
    'Greninja-Omega': {
    ...
    'Hover Pollen': {
        types: ['Grass', 'Dragon'],
        bs: { hp: 83, at: 55, df: 123, sa: 111, sd: 133, sp: 65 },
        weightkg: 135,
        gender: 'N',
        abilities: { 0: 'Protosynthesis' }
    },
    ...
    'Iron Pilot': {
        types: ['Steel', 'Electric'],
        bs: { hp: 78, at: 120, df: 100, sa: 120, sd: 60, sp: 112 },
        weightkg: 75.2,
        gender: 'N',
        abilities: { 0: 'Quark Drive' }
    },
    ...
    'Iron Shades': {
        types: ['Dark', 'Fighting'],
        bs: { hp: 92, at: 140, df: 104, sa: 74, sd: 64, sp: 96 },
        weightkg: 173.5,
        gender: 'N',
        abilities: { 0: 'Quark Drive' }
    },
    'Iron Storm': {
        types: ['Flying', 'Steel'],
        bs: { hp: 105, at: 110, df: 115, sa: 110, sd: 140, sp: 90 },
        weightkg: 240,
        gender: 'N',
        abilities: { 0: 'Quark Drive' }
    },
    ...
    'Iron World': {
        types: ['Grass', 'Electric'],
        bs: { hp: 64, at: 132, df: 150, sa: 64, sd: 128, sp: 32 },
        weightkg: 512,
        gender: 'N',
        abilities: { 0: 'Quark Drive' }
    },
    ...
    'Latias-Delta-Mega': {
        types: ['Dragon', 'Fairy'],
        bs: { hp: 80, at: 115, df: 130, sa: 125, sd: 140, sp: 110 },
        weightkg: 40,
        gender: 'N',
        abilities: { 0: 'Pressure' },
    ...
    Lucaurus: {
        types: ['Dark', 'Steel'],
        bs: { hp: 70, at: 105, df: 94, sa: 61, sd: 85, sp: 110 },
        weightkg: 49,
        abilities: { 0: 'Strong Jaw' }
    },
    'Luxray-Delta': {
        types: ['Electric', 'Fighting'],
        bs: { hp: 70, at: 132, df: 99, sa: 65, sd: 62, sp: 95 },
        weightkg: 56.5,
        abilities: { 0: 'Opportunist' }
    },
    Mabosstiff: {
    ...
    Maestrot: {
        types: ['Normal', 'Flying'],
        bs: { hp: 85, at: 70, df: 80, sa: 105, sd: 84, sp: 86 },
        weightkg: 4.5,
        abilities: { 0: 'Keen Eye' }
    },
    'Magearna-Delta': {
        types: ['Steel', 'Ghost'],
        bs: { hp: 80, at: 100, df: 110, sa: 130, sd: 125, sp: 50 },
        weightkg: 80.5,
        abilities: { 0: 'Soul Heart' },
        baseSpecies: 'Magearna'
    },
    ...
    Magirigus: {
        types: ['Psychic', 'Ghost'],
        bs: { hp: 58, at: 95, df: 105, sa: 50, sd: 145, sp: 30 },
        weightkg: 95,
        abilities: { 0: 'Run Away' }
    },
    'Malevorus-Incarnate': {
        types: ['Dark', 'Flying'],
        bs: { hp: 89, at: 100, df: 102, sa: 120, sd: 90, sp: 99 },
        weightkg: 65,
        gender: 'N',
        abilities: { 0: 'Guts' },
    ...
    'Marshadow-Delta': {
        types: ['Fire', 'Ghost'],
        bs: { hp: 60, at: 125, df: 90, sa: 125, sd: 105, sp: 95 },
        weightkg: 22.2,
        gender: 'N',
        abilities: { 0: 'Regenerator' }
    },
    ...
    'Metagross-Delta': {
        types: ['Rock', 'Grass'],
        bs: { hp: 80, at: 125, df: 145, sa: 75, sd: 110, sp: 65 },
        weightkg: 345.5,
        abilities: { 0: 'Bulletproof' }
    },
    'Mewrai': {
    ...
    Mewthree: {
        types: ['Dark'],
        bs: { hp: 106, at: 132, df: 85, sa: 148, sd: 85, sp: 124 },
        weightkg: 140,
        gender: 'N',
        abilities: { 0: 'Pressure' }
    },
    ...
    'Morgrem-Delta': {
        types: ['Ice', 'Fighting'],
        bs: { hp: 65, at: 70, df: 45, sa: 55, sd: 55, sp: 80 },
        weightkg: 18,
        gender: 'N',
        abilities: { 0: 'Frisk' }
    },
    ...
    Niveon: {
        types: ['Flying'],
        bs: { hp: 60, at: 95, df: 65, sa: 110, sd: 65, sp: 130 },
        weightkg: 22.5,
        abilities: { 0: 'Cloud Nine' }
    },
    'Noctowl-Delta': {
        types: ['Dark', 'Flying'],
        bs: { hp: 90, at: 62, df: 60, sa: 90, sd: 70, sp: 80 },
        weightkg: 38,
        abilities: { 0: 'Insomnia' },
        nfe: true
    },
    ...
    Operettot: {
        types: ['Normal', 'Flying'],
        bs: { hp: 85, at: 80, df: 90, sa: 100, sd: 80, sp: 75 },
        weightkg: 5,
        abilities: { 0: 'Keen Eye' }
    },
    Orthworm: {
    ...
    Perrception: {
        types: ['Normal', 'Psychic'],
        bs: { hp: 60, at: 40, df: 60, sa: 140, sd: 70, sp: 70 },
        weightkg: 10,
        abilities: { 0: 'Steadfast' }
    },
    Perrgatory: {
        types: ['Normal', 'Ghost'],
        bs: { hp: 70, at: 40, df: 50, sa: 100, sd: 80, sp: 100 },
        weightkg: 26,
        abilities: { 0: 'Levitate' }
    },
    Polfeegeist: {
    ...
    Quaxolotl: {
        types: ['Water', 'Fairy'],
        bs: { hp: 100, at: 65, df: 65, sa: 55, sd: 85, sp: 60 },
        weightkg: 50,
        abilities: { 0: 'Water Absorb' }
    },
    Quaxwell: {
    ...
    'Raticate-Delta': {
        types: ['Grass', 'Electric'],
        bs: { hp: 85, at: 42, df: 66, sa: 70, sd: 88, sp: 62 },
        weightkg: 18.5,
        abilities: { 0: 'Thick Fat' }
    },
    Rellor: {
    ...
    Scizantrum: {
        types: ['Bug', 'Rock'],
        bs: { hp: 84, at: 136, df: 132, sa: 68, sd: 56, sp: 84 },
        weightkg: 132,
        abilities: { 0: 'Strong Jaw' }
    },
    Scovillain: {
    ...
    'Secret Armor': {
        types: ['Fighting', 'Steel'],
        bs: { hp: 101, at: 141, df: 131, sa: 53, sd: 73, sp: 91 },
        weightkg: 32,
        gender: 'N',
        abilities: { 0: 'Protosynthesis' }
    },
    ...
    Slowhost: {
        types: ['Water', 'Electric'],
        bs: { hp: 85, at: 70, df: 75, sa: 130, sd: 100, sp: 30 },
        weightkg: 116,
        abilities: { 0: 'Usurped' }
    },
    Smoliv: {
    ...
    'Snorlax-Delta': {
        types: ['Normal', 'Grass'],
        bs: { hp: 160, at: 110, df: 110, sa: 65, sd: 65, sp: 30 },
        weightkg: 460,
        abilities: { 0: 'Thick Fat' }
    },
    Spectreon: {
        types: ['Ghost'],
        bs: { hp: 95, at: 60, df: 65, sa: 110, sd: 65, sp: 130 },
        weightkg: 0.1,
        abilities: { 0: 'Speed Boost' }
    },
    Spidops: {
    ...
    'Staraptor-Delta': {
        types: ['Fire', 'Flying'],
        bs: { hp: 85, at: 100, df: 80, sa: 60, sd: 60, sp: 100 },
        weightkg: 30.5,
        abilities: { 0: 'Welkin Torch' }
    },
    'Staralyx': {
        types: ['Steel', 'Psychic'],
        bs: { hp: 75, at: 50, df: 105, sa: 85, sd: 90, sp: 115 },
        weightkg: 180,
    ...
    'Tinkaton-Delta': {
        types: ['Fairy', 'Water'],
        bs: { hp: 85, at: 90, df: 95, sa: 65, sd: 77, sp: 94 },
        weightkg: 218.5,
        abilities: { 0: 'Suction Cups' }
    },
    'Tinkaton-Gamma': {
        types: ['Fairy', 'Flying'],
        bs: { hp: 85, at: 45, df: 67, sa: 110, sd: 105, sp: 94 },
        weightkg: 15.6,
        abilities: { 0: 'Dazzling' }
    },
    'Tinkaton-Omega': {
    ...
    'Torkoal-Delta': {
        types: ['Fire', 'Water'],
        bs: { hp: 70, at: 60, df: 150, sa: 95, sd: 75, sp: 20 },
        weightkg: 80.4,
        abilities: { 0: 'Flame Body' }
    },
    Turnizone: {
        types: ['Grass', 'Ground'],
        bs: { hp: 95, at: 50, df: 110, sa: 110, sd: 130, sp: 40 },
        weightkg: 120,
        abilities: { 0: 'Water Absorb' }
    },
    'Typhlosion-Delta': {
        types: ['Electric'],
        bs: { hp: 73, at: 84, df: 73, sa: 124, sd: 80, sp: 100 },
        weightkg: 75.5,
        abilities: { 0: 'Drizzle' }
    },
    'Ursaluna': {
    ...
    Ursanette: {
        types: ['Normal', 'Ghost'],
        bs: { hp: 96, at: 128, df: 76, sa: 104, sd: 88, sp: 68 },
        weightkg: 120,
        gender: 'N',
        abilities: { 0: 'Mind\'s Eye' }
    },
    ...
    'Volcanion-Delta': {
        types: ['Dark', 'Poison'],
        bs: { hp: 80, at: 110, df: 90, sa: 130, sd: 120, sp: 70 },
        weightkg: 175,
    ...
    'Vrelie': {
        types: ['Psychic'],
        bs: { hp: 100, at: 95, df: 80, sa: 95, sd: 80, sp: 130 },
        weightkg: 0.3,
        abilities: { 0: 'Levitate' },
        otherFormes: ['Vrelie-Delta']
    },
    'Vrelie-Delta': {
        types: ['Poison', 'Ghost'],
        bs: { hp: 100, at: 95, df: 80, sa: 95, sd: 80, sp: 130 },
    ...
    'Wooper-Delta': {
        types: ['Water', 'Fairy'],
        bs: { hp: 45, at: 20, df: 35, sa: 55, sd: 45, sp: 10 },
        weightkg: 8.5,
        abilities: { 0: 'Water Absorb' },
        nfe: true
    },
    ...
    Zephior: {
        types: ['Flying'],
        bs: { hp: 60, at: 60, df: 80, sa: 100, sd: 80, sp: 120 },
        weightkg: 0.5,
        gender: 'N',
        abilities: { 0: 'Tempest Veil' }
    },
    'Zeraora-Delta': {
        types: ['Fire'],
    ...
    'Striding Sun': {
        types: ['Steel', 'Dragon'],
        bs: { hp: 61, at: 145, df: 153, sa: 97, sd: 53, sp: 81 },
        weightkg: 255,
        gender: 'N',
        abilities: { 0: 'Protosynthesis' }
    },
    'Iron Moon': {
        types: ['Psychic', 'Steel'],
        bs: { hp: 50, at: 100, df: 74, sa: 152, sd: 140, sp: 74 },
        weightkg: 185,
        gender: 'N',
        abilities: { 0: 'Quark Drive' }
    },
    'Lumrunt': {
        ...
        weightkg: 0.3,
        gender: 'N',
        abilities: { 0: 'Malice Mender' }
    },
    'Aspearunt': {
        types: ['Ice', 'Ghost'],
        bs: { hp: 88, at: 88, df: 88, sa: 160, sd: 88, sp: 88 },
        weightkg: 0.3,
        gender: 'N',
        abilities: { 0: 'Freeze Fanatic' }
    },
    'Rawstrunt': {
        types: ['Fire', 'Ghost'],
        bs: { hp: 88, at: 160, df: 88, sa: 88, sd: 88, sp: 88 },
        weightkg: 0.3,
        gender: 'N',
        abilities: { 0: 'Freeze Fanatic' }
    },
    'Persimrunt': {
        types: ['Psychic', 'Ghost'],
        bs: { hp: 88, at: 88, df: 88, sa: 88, sd: 160, sp: 88 },
        weightkg: 0.3,
        gender: 'N',
        abilities: { 0: 'Confusion Conjurer' }
    },
    'Chestorunt': {
        types: ['Normal', 'Ghost'],
        bs: { hp: 160, at: 88, df: 88, sa: 88, sd: 88, sp: 88 },
        weightkg: 0.3,
        gender: 'N',
        abilities: { 0: 'Sleep Sentinel' }
    },
    'Cherirunt': {
        types: ['Electric', 'Ghost'],
        bs: { hp: 88, at: 88, df: 88, sa: 88, sd: 88, sp: 160 },
        weightkg: 0.3,
        gender: 'N',
        abilities: { 0: 'Sleep Sentinel' }
    }
